...
def predict():
    ...
    if single == 1:
        result_page = "redpage.html"
        o1 = "This customer is likely to be churned!!"
        o2 = "{}% chances of churning".format(int(probablity*100))
    else:
        result_page = "greenpage.html"
        o1 = "This customer is likely to continue!!"
        o2 = "{}% chances of churning".format(int(probablity*100))

    return render_template(result_page, output1=o1, output2=o2,
